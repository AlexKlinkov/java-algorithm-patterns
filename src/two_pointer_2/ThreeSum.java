...
/**
 * One way of solution 🔵 **LeetCode #15 (Valid Palindrome)**
 *
...
public class ThreeSum {
    ...
    /**
     * Collects all variants where summation of three digital gives sum = zero
     *
     * @param nums - the initial array
     * @return a list with all triplets which gives zero-sum, excluding duplicated ones
     */
