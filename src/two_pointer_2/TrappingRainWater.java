...
/**
 * One way of solution 🔴 **LeetCode #42 (Minimum Size Subarray Sum)**
 *
...
public class TrappingRainWater {
    ...
    /**
     * Takes a digital which represents amount of saving water in some boundaries
     *
     * @param height - represents vessel with tanks (0 - value into array) between the leftmost and the right value of the array
     * @return the possible quantity of the storing water units
     */
