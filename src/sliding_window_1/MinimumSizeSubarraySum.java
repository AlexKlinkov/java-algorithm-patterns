...
/**
 * One way of solution 🔵 **LeetCode #209 (Minimum Size Subarray Sum)**
 *
...
public class MinimumSizeSubarraySum {
     ...
     * whose sum is **at least** the target value.
     *
     * @param target - the minimum sum required (subarray sum must be >= target)
     * @param nums   - array of integers
     * @return length of the smallest subarray satisfying sum >= target,
